...
<div>
  ...
  <div class="col-md-3">
    <label></label>
    <input type="text" class="form-control filter" name="tsawal" placeholder="Dari" value="<?php echo $tsawal; ?>"></input>
  </div>
  <div class="col-md-3">
    <label></label>
    <input type="text" class="form-control filter" name="tsakhir" placeholder="Ke" value="<?php echo $tsakhir; ?>"></input>
  </div>
  <div class="col-md-3">
    <label></label>
